...
public class AuthService :IAuthService
{
    ...
    public AuthService(IBaseRepository<User> repository, IMapper mapper, ILogger logger, IBaseRepository<UserToken> userTokenRepository, ITokenService tokenService)
    {
